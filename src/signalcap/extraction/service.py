...
class SignalExtractor:
    ...
    async def extract(self, transcript: str) -> ExtractedSignals:
        ...
        try:
            ...
            if not content:
                raise ExtractionError("LLM returned no structured extraction")
            ...
            raise ExtractionError("LLM returned malformed extraction data") from exc
        except Exception as exc:
            raise ExtractionError("LLM extraction request failed") from exc
